            ...
            <form class="row" action="/running-transaction/update" method="POST">
              ...
              <div class="col-md-6">
                <div class="form-group col-md-12">
                  ...
                  <input type="text" class="form-control" id="tp-1" name="tp-1" value="<?= $row['tp-1']; ?>" required>
                </div>

                <div class="form-group col-md-12">
                  <label for="tp-2">Tp 2</label>
                  <input type="text" class="form-control" id="tp-2" name="tp-2" value="<?= $row['tp-2']; ?>" required>
                </div>

                <div class="form-group col-md-12">
                  <label for="tp-3">Tp 3</label>
                  <input type="text" class="form-control" id="tp-3" name="tp-3" value="<?= $row['tp-3']; ?>" required>
                </div>
